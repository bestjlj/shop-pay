package com.jlj.shoppay.config;
...
public class BestPayConfig {
    ...
    public BestPayService bestPayService(){
        ...
        wxPayConfig.setNotifyUrl("http://jlj.natapp1.cc/notify");
        ...
        aliPayConfig.setNotifyUrl("http://jlj.natapp1.cc/notify");
        aliPayConfig.setReturnUrl("https://127.0.0.1");
